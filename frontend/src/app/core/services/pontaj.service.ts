...
export class PontajService {
  ...
  exportPontajByProiect(year: number, month: number, projectId: number) {
    let params = new HttpParams();
    params = params.append('year', year);
    params = params.append('month', month);
    params = params.append('projectId', projectId);

    return this.http.get(this.baseUrl + 'pontaj/export-with-project', {params, responseType: 'blob', withCredentials: true});
  }
